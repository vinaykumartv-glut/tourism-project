...
Xtrain_path = "hf://datasets/vinaykumartv/tourism-project-data/Xtrain.csv"
Xtest_path = "hf://datasets/vinaykumartv/tourism-project-data/Xtest.csv"
ytrain_path = "hf://datasets/vinaykumartv/tourism-project-data/ytrain.csv"
ytest_path = "hf://datasets/vinaykumartv/tourism-project-data/ytest.csv"
...
api.upload_file(
    path_or_fileobj="best_tourism_project_model.joblib",
    path_in_repo="best_tourism_project_model.joblib",
    repo_id=repo_id,
    repo_type=repo_type,
)
